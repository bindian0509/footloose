...
<title>Columns Layout | Welcome Inn</title>
...
<div class="menu-header">
	<div class="container">
	        ...
	        <ul class="topmenu">
				...
				<li class="current-menu-ancestor parent"><a href="#">Shortcodes</a>
                	<ul class="sub-menu">
                        <li class="first"><a href="shortcodes.php">HTML</a></li>
                        <li class="last current-menu-parent"><a href="columns.php">Columns Layout</a></li>
                    </ul>
                </li>
...
<div class="container">
	...
	<div class="header-title-image">
    	...
    	<h1><span>Examples of </span> Columns Layout</h1>
    </div>
