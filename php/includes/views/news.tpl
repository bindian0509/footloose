...
<div class="container">
	...
	<div class="header-title-image">
    	...
    	<h1><span>Find out more</span> News &amp; Promos</h1>
    </div>
    ...
    <div class="container_24">
    	...
    	<div class="grid_17 suffix_1">
		  <div class="text">
            ...
            <!-- newslist -->
	  <div class="news-item">
	                <h2><a href="news-details.php">Limited offer: Stay 1 night, get 2nd free</a></h2>
                    <img src="/static/images/temp_news_1.jpg" alt="" width="234" height="112" class="alignleft" />
					<div class="entry">
                    ...
                    <div class="news-meta"><a href="news-details.php" class="link-more alignleft">Find out more</a> <a href="news-details.php">8 comments</a></div>
              	</div>
                
	  <div class="news-item">
	                <h2><a href="news-details.php">NEW POOL open for public</a></h2>
              		<img src="/static/images/temp_news_2.jpg" alt="" width="234" height="112" class="alignright" />
	  		  <div class="entry">
   			<p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi dolor sit amet coloqseum. </p>
       				</div>
                    <div class="news-meta"><a href="news-details.php" class="link-more alignleft">Find out more</a> <a href="news-details.php">5 comments</a></div>
              	</div>
                
       	  <div class="news-item">
                <h2><a href="news-details.php">RELAX MORE with our "BREKFAST IN BED" service!</a></h2>
                  <img src="/static/images/temp_news_3.jpg" alt="" width="670" height="110" class="aligncenter" />
				  <div class="entry">
       			    <p>Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi dolor sit amet coloqseum. </p>
   				</div>
                    <div class="news-meta"><a href="news-details.php" class="link-more alignleft">Find out more</a> <a href="news-details.php">8 comments</a></div>
		  ...
		  <!--/ newslist -->              
              	...
              	<p class="pages">
			  	<a href="#" class="page_prev">BACK</a> <a href="#" class="page_current">1</a> <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a>  ...   <a href="#">15</a> <a href="#" class="page_next">NEXT</a>                </p>
       	  </div>
        </div>
        <!--/ content -->
        <!-- sidebar -->
