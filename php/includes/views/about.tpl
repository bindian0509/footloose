...
<div class="container">
	...
	<div class="header-title-image">
    	<div class="image"><img src="/static/images/header/header_1.jpg" width="708" height="124" alt="" /></div>
    	<h1><span>Find out more</span> About us</h1>
    </div>
